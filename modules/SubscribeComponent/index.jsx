...
const SubscribeComponent = ({ flex }) => {
	...
	return (
		...
		>
			...
			<input
				className="p-2 focus:none outline-none border hover:bg-gray-50 cursor-pointer border-gray-900 rounded-md m-2 dark:bg-gray-900 dark:border-gray-800 dark:hover:border-gray-700"
